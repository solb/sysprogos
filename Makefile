...
U_C_BIN = user/init.b user/shell.b user/cat.b user/dref_nul.b user/oflo_sta.b user/uflo_sta.b user/stp_pic.b user/spwn_nul.b user/sspwnnul.b user/clob_gdt.b user/ls.b user/clear.b
U_C_OBJ = user/init.o user/shell.o user/cat.o user/dref_nul.o user/oflo_sta.o user/uflo_sta.o user/stp_pic.o user/spwn_nul.o user/sspwnnul.o user/clob_gdt.o user/ls.o user/clear.o
